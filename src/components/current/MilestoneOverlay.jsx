...
export default function MilestoneOverlay({ days, sobrietyDate, savingsRate, onDismiss, onShare }) {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] uppercase tracking-widest font-medium mb-6" style={{ color: '#c8a97e' }}>
          Milestone Reached
        </p>
        ...
        <p className="text-xs mb-10" style={{ color: '#8a8478' }}>
          {dateRange}
        </p>
        ...
        <div 
          ...
          style={{ borderColor: '#c8a97e', backgroundColor: '#0e0e0f' }}
        >
          <span className="font-display text-3xl font-medium" style={{ color: '#c8a97e' }}>
            {days}
          </span>
          <span className="small-caps text-[10px] tracking-widest mt-1" style={{ color: '#8a8478' }}>
            Days
          </span>
        </div>
        ...
        <div className="flex gap-6 mb-12">
          {[
            ...
            <div key={s.label} className="text-center">
              ...
              <p className="text-[10px] uppercase tracking-widest mt-1" style={{ color: '#8a8478' }}>
                {s.label}
              </p>
            </div>
          ))}
