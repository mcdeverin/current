    ...
    <div className="py-4 border-b" style={{ borderColor: 'var(--card-border)' }}>
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-xl flex-shrink-0 overflow-hidden"
          style={{ backgroundColor: 'var(--accent-light, var(--card))' }}>
          {place.profile_image ? (
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-display text-base font-medium leading-tight" style={{ color: 'var(--text)' }}>
            {place.name}
          </h3>
          ...
          {place.description && (
            <p className="text-xs mt-1.5 leading-relaxed italic" style={{ color: 'var(--subtext)' }}>
              {place.description}
            </p>
          )}
          {place.tag && (
            <span
              ...
              style={{ backgroundColor: 'var(--accent-light, rgba(111,143,164,0.15))', color: 'var(--accent)' }}
            >
              {place.tag}
            </span>
          )}
