...
export default function ToneGuideModal({ onClose }) {
  return (
    <motion.div
      ...
      style={{ backgroundColor: 'rgba(15,18,25,0.7)' }}
      onClick={onClose}
    >
      <motion.div
        initial={{ y: 100 }}
        ...
        style={{ backgroundColor: '#eef0ec' }}
        onClick={e => e.stopPropagation()}
      >
        <div className="w-8 h-1 rounded-full mx-auto mb-6" style={{ backgroundColor: '#d4dcd5' }} />
        
        <h2 className="font-display text-xl font-medium text-gray-900 mb-4">
          Before you share.
        </h2>
        
        <p className="text-sm leading-relaxed mb-3" style={{ color: '#6a7280' }}>
          This is a space for moments, not advice.
        </p>
        <p className="text-sm leading-relaxed mb-3" style={{ color: '#6a7280' }}>
          Share what's true. Keep it short.
        </p>
        <p className="text-sm leading-relaxed mb-6" style={{ color: '#6a7280' }}>
